                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_pasien" value="<?=$row['nama_pasien'];?>">
                                </div>
                                <div style="display: flex;">
                                    <div class="form-group" style="margin-right: 20px; width: 400px;">
                                        <label for="tinggiBadan">No. KTP</label>
                                        <input type="text" class="form-control" name="no_ktp" maxlength="16" value="<?=$row['nomor_ktp'];?>" pattern="\d{16}" title="No. KTP harus terdiri dari 16 karakter angka">
                                    </div>
                                    <div class="form-group" style="margin-right: 20px; width: 400px;">
                                ...
                                <div class="form-row" style="display: flex;">
                                    <div class="form-group" style="margin-right: 20px; width: 400px;">
                                        ...
                                        <input type="number" class="form-control" name="tinggi_badan" value="<?=$row['tinggi_badan'];?>">
                                    </div>
                                    <div class="form-group" style="margin-right: 20px; width: 400px;">
                                        <label for="beratBadan">Berat Badan (kg)</label>
                                        <input type="number" class="form-control" name="berat_badan" value="<?=$row['berat_badan'];?>">
                                    </div>
                                    <div class="form-group" style="width: 500px;">
                                        <label for="beratBadan">Golongan Darah</label>
                                        <select class="form-control form-select" name="golongan_darah" value="<?=$row['golongan_darah'];?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="riwayat_alergi" value="<?=$row['riwayat_alergi'];?>">
                                </div>
